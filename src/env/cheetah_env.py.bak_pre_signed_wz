        ...
        if mode in ("walk", "run"):
            ...
            if mode == "run":
                ...
                total = (
                    ...
                    + 10.0 * r_wz_track      # v31s6d: boosted (6→10) — yaw 95%→66% gradient imbalance vs vx (11/step vs 5.5)
                    + 5.0 * r_wz_lin         # v31s6d: boosted (3→5) — sustain yaw gradient
