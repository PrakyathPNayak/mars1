        ...
        if mode in ("walk", "run"):
            ...
            if mode == "run":
                ...
                total = (
                    ...
                    - 2.0 * r_vx_unwanted    # v31d: anti-forward-bias
                    - 1.5 * r_vy_unwanted    # v31d: anti-lateral-drift
                    - 2.0 * r_wz_unwanted    # v31d: anti-spin
                )
                scaled_components = {
                ...
                total = (
                    ...
                    - 3.0 * r_vx_unwanted    # v31d: anti-forward-bias
                    - 2.5 * r_vy_unwanted    # v31d: anti-lateral-drift
                    - 4.0 * r_wz_unwanted    # v31d: STRONG anti-spin (policy was spinning wz=-0.46!)
                )
                scaled_components = {
